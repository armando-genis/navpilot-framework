...
{
public:
    HybridAstar(Grid_map grid_map, CarData car_data, double simulationLength, double step_car, const vector<Eigen::VectorXd> &reference_path);
...
private:
    ...
    vector<Eigen::VectorXd> reference_path_;
    double proximityWeight = 10.0;

...
private:
    ...
    double track_car = 1;
    double start_offset = 1.0; // 0.5 meters offset in front of the car
    ...
    void publish_crosswalk_polygon_markers(const traffic_information_msgs::msg::RoadElementsCollection::SharedPtr msg);
    ...
    // publisher for the closest waypoint
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr closest_waypoint_marker_publisher_;
    // publisher for the crosswalk polygon
    rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr crosswalk_polygon_marker_publisher_;
public:

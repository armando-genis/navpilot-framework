...
public:
  ...
  boost::shared_ptr<pcl::NormalDistributionsTransform<pcl::PointXYZI, pcl::PointXYZI>> coarse_ndt_;
  pclomp::NormalDistributionsTransform<pcl::PointXYZI, pcl::PointXYZI>::Ptr coarse_ndt_omp_;
  ...
  double ndt_coarse_resolution_;
  double ndt_coarse_step_size_;
  int ndt_coarse_max_iterations_;
  double map_crop_half_xy_;
  double map_crop_half_z_;

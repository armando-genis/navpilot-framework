...
// Local pose result type (replace YOLO-CPP; compatible with postprocessing)
struct Keypoint { float x, y, confidence; };
struct PoseBox { float x, y, width, height; };
struct PoseResult {
  PoseBox box;
...
#endif  // MULTICAMERA_DETECTION_TENSORT__MULTICAMERA_SUBSCRIBER_HPP_
